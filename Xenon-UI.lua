...
function LibraryV2.UI(Name)
    ...
    local Library
    Library = {
        _UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/Tobias020108Back/YBA-AUT/main/Xenon-UI2", true))(),
    ...
    TopMenu.last.Text = "Ur last Visit: "..ELib_Data.Last_Visit
    TopMenu.cf.Text = "CFG Name: "..ELib_Data.Config_Name
        ...
        while wait(0.25) do
            ...
            if Data_ then
                ...
                if Returned.Artist == "" then
                    MusicPlayer.Author.Text = "Didnt find Artist"
                end
            end
        end
